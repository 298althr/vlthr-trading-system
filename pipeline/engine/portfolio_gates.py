...
class RiskBudgetLedger:
    ...
    MAX_PORTFOLIO_RISK_PCT = PORTFOLIO["max_portfolio_risk_pct"]  # 12.0%
...
class TradeCountGuard:
    ...
    MAX_ACTIVE = PORTFOLIO["max_active_trades"]      # 8
    MAX_DAILY = PORTFOLIO["max_daily_trades"]         # 10
    SESSION_LIMITS = PORTFOLIO["session_limits"]        # {"london": 4, "ny_late": 4}
...
class CorrelationGuard:
    """
    All 5 crypto symbols treated as one correlated cluster.
    Max 8 open positions total (regardless of symbol).
