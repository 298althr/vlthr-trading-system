...
## VLTHR Calibration (B1-B5) — Pre-V7 Results

> **Note:** The B1-B5 calibration results below are from pre-V7 backtests. V7 uses isotonic calibration filter (`calibrated_win_prob > 0.48`) as the primary gate, achieving 88/100 institutional score. The DRVE tournament approach is not used in V7 production.
