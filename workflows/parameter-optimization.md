...
## V7 Parameters (GOLD STANDARD — DO NOT CHANGE)
- Entry filter: `calibrated_win_prob > 0.48` (isotonic calibration, IS 75% split)
- V3 scorer weights: tech 0.00, struct 0.00, ctx 1.00
- Kelly bands: 85+:0x (VETO), 80-85:2.5x, 75-80:1.5x, 70-75:1.0x, 65-70:0.7x, <65:0.3x
