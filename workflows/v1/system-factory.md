...
### Production Systems (V2 Live)
- `confidence_engine` — DQS scoring, enriched data loading
- `portfolio_orchestrator` — main pipeline, V2 filters, calibration gate
- `v2_filters` — daily bias, volume, RSI momentum, regime, BTC correlation
- `calibration_lookup` — Wilson LB gate, calibrated probability

### Shadow Systems (V3)
- `probe_engine` — feature discovery, IC validation
- `hypothesis_engine` — Bayesian hypothesis testing
- `scenario_engine` — regime detection, robustness
- `decision_engine` — decision intelligence, ABSTAIN gate
